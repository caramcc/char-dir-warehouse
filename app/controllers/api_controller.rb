class ApiController < ApplicationController
  ...
  def reaping_list
    ...
    possibles = rc.last.characters.preload(:user)
  ...
  def reaping
    ...
    possibles.each do |possible|
      ...
      by_district_gender[dg_id].fill(possible, by_district_gender[dg_id].size, odds)

    end

    by_district_gender.sort.each do |dg_id, tributes|
